...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$email || !$password || !$passwordRpt || !$name) {
        ...
        if ($password != $passwordRpt) {
            ...
            $sql = "INSERT INTO users (email, username, pshash) VALUES ('$email', '$name', '$hashedPassword')";
        ...
        <div id="main-wrapper">
            ...
            <form method="POST" action="./index.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="passwordRpt" name="passwordRpt" placeholder="******">
                </div>
                <div class="mb-3">
